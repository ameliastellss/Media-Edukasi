  ...
  <section class="about_section layout_padding long_section">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="template1/images/logo.png" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              Media Edukasi merupakan aplikasi yang bergerak di bidang pendidikan berbasis web. Didirikan pada Januari 2024, Media Edukasi mengembangkan platform online pembelajaran yang dapat diakses oleh siswa dan juga pengajar yang berisi kumpulan materi pembelajaran, latihan soal dan rangkuman materi berkualitas premium.
            </p>
