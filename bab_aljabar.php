    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/materi_mat.png" alt="">
            </div>
            <div class="detail-box">
              ...
              <div class="price_box">
                ...
                <a href="https://www.its.ac.id/matematika/wp-content/uploads/sites/42/2018/08/BukuAljabar_2022.pdf">
                  Buka
                </a>
              </div>
            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/latsol_mat.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Latihan Soal
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/17.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Rangkuman
