    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/materi_bing.png" alt="">
            </div>
            <div class="detail-box">
              ...
              <div class="price_box">
                ...
                <a href="https://digilib.ikippgriptk.ac.id/id/eprint/484/3/BAB%20II.pdf">
                  Buka
                </a>
              </div>
            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/latsol_bing.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Latihan Soal
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/19.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Rangkuman
