    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/materi_biologi.png" alt="">
            </div>
            <div class="detail-box">
              ...
              <div class="price_box">
                <h6 class="price_heading"></h6>
                <a href="http://file.upi.edu/Direktori/FPOK/JUR._PEND._KESEHATAN_&_REKREASI/PRODI._KEPERAWATAN/197011022000121-HAMIDIE_RONALD_DANIEL_RAY/Bahan_Kuliah/sistem-pencernaan.pdf">
                  Buka
                </a>
              </div>
            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/latsol_biologi.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Latihan Soal
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/20.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Rangkuman
