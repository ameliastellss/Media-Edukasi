    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/materi_kimia.png" alt="">
            </div>
            <div class="detail-box">
              ...
              <div class="price_box">
                ...
                <a href="https://staffnew.uny.ac.id/upload/198001032009122001/pendidikan/struktur-atom.pdf">
                  Buka
                </a>
              </div>
            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/latsol_kimia.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Latihan Soal
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/21.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Rangkuman
