    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/materi_fisika.png" alt="">
            </div>
            <div class="detail-box">
              ...
              <div class="price_box">
                ...
                <a href="https://repositori.kemdikbud.go.id/22210/1/XI_Fisika_KD-3.5_Final.pdf">
                  Buka
                </a>
              </div>
            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/latsol_fisika.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Latihan Soal
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/22.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Rangkuman
