    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/materi_ind.png" alt="">
            </div>
            <div class="detail-box">
              ...
              <div class="price_box">
                ...
                <a href="https://files1.simpkb.id/guruberbagi/rpp/656970-1670640963.pdf">
                  Buka
                </a>
              </div>
            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/latsol_bind.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Latihan Soal
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="template1/images/18.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Rangkuman
