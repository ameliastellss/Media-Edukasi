...
--
-- Table structure for table `soal_listrik`
--

CREATE TABLE `soal_listrik` (
  `id_soal` int(11) NOT NULL,
  `soal` text NOT NULL,
  `A` varchar(50) NOT NULL,
  `B` varchar(50) NOT NULL,
...
--
-- Dumping data for table `soal_listrik`
--

INSERT INTO `soal_listrik` (`id_soal`, `soal`, `A`, `B`, `C`, `D`, `kunci`, `gambar`, `tanggal`, `aktif`) VALUES
(1, 'Sebuah bola konduktor berjari – jari 9 cm diberi muatan 6 mC. Besar kuat medan listrik dan potensial listrik pada titik yang berjarak 3 cm dari pusat bola adalah …', 'sama sama nol', 'E = nol, V = 6. 105volt', 'E = 6. 107N/C, V = nol', 'E = 6. 107N/C, V = 6. 105volt', 'B', '', '2018-07-02', 'Y'),
(2, 'Dua keping logam yang sejajar dan jaraknya 0,5 cm satudari yang lain diberi muatan listrik yang berlawanan hingga beda potensial 10000 Volt. Bila muatan elektron adalah 1,6 x 10-19 C maka besar dan arah gaya coulomb pada sebuah elektron yang ada diantara kedua keping adalah …', '0,8 x 10-7 N ke atas', '0,8 x 10-7 N ke bawah', '3,2 x 10-13 N ke atas', '3,2 x 10-13 N ke bawah', 'C', '', '2018-07-02', 'Y'),
(3, 'Kapasitas kapasitor dapat diperkecil dengan cara-cara sebagai berikut :<br></br>\r\n\r\n(1)  ruang antar lempeng diisi minyak<br></br\r\n\r\n(2) dengan pasangan seri beberapa kapasitor<br></br\r\n\r\n(3) jarak kedua lempeng diperkecil<br></br\r\n\r\n(4) luas lempengnya diperkecil.<br></br\r\n\r\nmaka ciri yang benar adalah ….', '1,2,3, dan 4', '1,2, dan 3', '1 dan 3', '2 dan 4', 'D', '', '2018-07-18', 'Y'),
(4, 'Tiga buah kapasitor identik yang mula-mula belum bermuatan akan dihu-bungkan dengan baterai 15 V. Bila hanya salah satunya saja yang dihubungkan dengan baterai 15 V tersebut, energi yang tersimpan dalam kapasitor adalah 3/2E. Energi yang akan tersimpan bila ketiga kapasitor tadi dihubungkan seri dengan baterai adalah …', '¼ E', '½ E', '2E', '4E', 'B', '', '2018-07-02', 'Y'),
(5, 'Tiga kapasitor A, B, dan C masing-masing berkapasitas 4F, 6F, dan 12F disusun seri kemudian dihubungkan dengan tegangan 90V. Apabila muatan listrik masing-masing kapasitor qA, qB, dan qC maka …', 'qC = 3 x qA', 'qA<qB<qC', 'qC = 1/3 x qA', 'qA = qB = qC', 'D', '', '2018-07-02', 'Y'),
(6, 'Sebuah kapasitor dengan kapasitansi 2.10-5F yang pernah dihubungkan untuk  beberapa saat lamanya pada beda potensial 500 V. Kedua ujungnya dihubungkan dengan ujung-ujung sebuah kapasitor lain dengan kapasitansinya 3.10-5 F yang tidak bermuatan. Energi yang tersimpan di dalam kedua kapasitor adalah …', '0,25J', '0.50J', '1,00J', '1,25J', 'D', '', '2018-07-02', 'Y'),
(7, 'Dua muatan titik yang sejenis dan sama besar qA = qB =10 –2C pada jarak10 cm satu dari yang lain. Gaya tolak yang dialami kedua muatan itu (dalam Newton) adalah …', '9.10–14', '9.10–9', '9.10–5', '9.10–7', 'D', '', '2020-10-04', 'Y');
...
--
-- Table structure for table `soal_suhu`
--

CREATE TABLE `soal_suhu` (
  `id_soal` int(11) NOT NULL,
  `soal` text NOT NULL,
  `A` varchar(50) NOT NULL,
  `B` varchar(50) NOT NULL,
...
--
-- Dumping data for table `soal_suhu`
--

INSERT INTO `soal_suhu` (`id_soal`, `soal`, `A`, `B`, `C`, `D`, `kunci`, `gambar`, `tanggal`, `aktif`) VALUES
(1, 'Berikut ini yang merupakan peristiwa pemuaian adalah …', 'Jemuran mengering terkena sinar matahari', 'Raksa dalam termometer yang naik turun mengikuti s', 'Air yang membeku menjadi es terlihat menjadi besar', 'Kembang api yang dibakar saat perayaan', 'B', '', '2018-07-02', 'Y'),
(2, 'Sebanyak 500 g es diletakkan pada wadah yang berisi 100 g air bersuhu 0oC. Keduanya dikondisikan pada keadaan adiabatik, maka...', 'Keadaan air dan es tetap', 'Seluruhnya menjadi air', 'Seluruhnya menjadi es ', 'Air membeku sebanyak 50 gram', 'A', '', '2018-07-02', 'Y'),
(3, 'Tentukan perubahan suhu air terjun yang jatuh dari ketinggian 1 km, jika seluruh energinya berubah menjadi kalor...', '4,17', '3,6', '2,4', '1,2', 'C', '', '2018-07-18', 'Y'),
(4, 'Logam berbentuk lempeng lingkaran yang terdapat lubang di bagian tengah akan mengalami pemuaian hingga tidak terdapat lubang. Hal tersebut...', 'dapat terjadi karena logam mempunyai ke arah luban', 'tidak dapat terjadi karena logam keterbatasan ruan', 'dapat terjadi karena logam memuai ke segala arah', 'tidak dapat terjadi karena perbedaan suhu pada lub', 'D', '', '2018-07-02', 'Y'),
(5, 'Jika kalor jenis es adalah 0,5 kkal/kgoC, maka jumlah total kalor yang diperlukan untuk menaikan suhu 4 kg es dari -66 K hingga -36 K adalah...', '99 kkal', '88 kkal', '60 kkal', '55 kkal', 'C', '', '2018-07-02', 'Y'),
(6, 'Es kepal milo jumbo terbuat dari 500 gr milo dengan suhu 5oC. Jika kalor jenis milo setara dengan kalor jenis air maka massa es yang digunakan agar suhu tetap 0oC adalah...', '0,1125 gr', '0,2125 gr', '0,3125 gr', '0,4125 gr', 'C', '', '2018-07-02', 'Y'),
(7, 'Hot green tea latte terbuat dari teh hijau panas bersuhu 80oC dan caramel dingin bersuhu 10oC dengan perbandingan massa 10:1. Suhu campuran Hotel green tea latte dan caramel tersebut adalah...', '75,5oC', '74,5oC', '73,6oC', '72,5oC', 'C', '', '2020-10-04', 'Y');
...
('BG07', 'Materi Belajar Pembelahan Sel', 'Materi Belajar Pembelahan Sel.pdf', 5762242, 'pdf', 'file/Materi Belajar Pembelahan Sel.pdf');
...
INSERT INTO `tb_rangkuman` (`kode_buku`, `nama_buku`, `title`, `size`, `ekstensi`, `berkas`) VALUES
('TB01', 'Ragkuman Bab Medan Magnet', 'Rangkuman Medan Magnet.pdf', 574495, 'pdf', 'file/Rangkuman Medan Magnet.pdf'),
('TB02', 'Ragkuman Bab Passive Voice', 'Rangkuman Bab Passive Voice.pdf', 377879, 'pdf', 'file/Rangkuman Bab Passive Voice.pdf'),
('TB03', 'Ragkuman Bab Listrik Statis', 'Rangkuman Listrik Statis.pdf', 583768, 'pdf', 'file/Rangkuman Listrik Statis.pdf'),
('TB04', 'Ragkuman Bab Bangun Ruang', 'Rangkuman Bab Bangun Ruang.pdf', 769867, 'pdf', 'file/Rangkuman Bab Bangun Ruang.pdf');
...
(6, 'memel', 'memel26@gmail.com', '$2y$10$ppJ07Sbk5uGJiBx5nnIKzeIwo7VgZObyKm8P8btBY0gqZc25gtGcO', 'stella amelia', 'default.svg'),
(7, 'lala', 'lala3@gmail.com', '$2y$10$nj/F90ure4WYLJ/fm9fZSuH1C/ctSw.550NRqS42DZG2uqF/f7eVm', 'lala', 'profil.svg'),
(8, 'kawako', 'nanchannarong02@gmail.com', '$2y$10$olMebG5TazFrDDI.N2JugODwkYG7DokbGChjZP89rU0gcnr6mMTPu', 'kawa', 'default.svg'),
(9, 'riri', 'riri903@gmail.com', '$2y$10$uUq38tecGwjKN43URKW.3..zBYTfXQoYnMqdzPBkb/6nnI8F1Cc3i', 'riri', 'default.svg'),
(10, 'amelia', 'ameliastella7889@gmail.com', '$2y$10$h9uff7BOqDi9wbkpTAxBQuVyfnSSh82mzxIFZAOViFvQes/sd2742', 'amelia', 'profil.svg'),
(11, 'amelll', 'ameliastella903@gmail.com', '$2y$10$XbBZo4iacQ2PP3Ge9raFDOa.G554ItwK6xDIDlEMQdb61TbfC707W', 'amel', 'profil.svg');
...
--
-- Indexes for table `soal_listrik`
--
ALTER TABLE `soal_listrik`
  ADD PRIMARY KEY (`id_soal`);
...
--
-- Indexes for table `soal_suhu`
--
ALTER TABLE `soal_suhu`
  ADD PRIMARY KEY (`id_soal`);
...
--
-- AUTO_INCREMENT for table `soal_listrik`
--
ALTER TABLE `soal_listrik`
  MODIFY `id_soal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT for table `soal_suhu`
--
ALTER TABLE `soal_suhu`
  MODIFY `id_soal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
