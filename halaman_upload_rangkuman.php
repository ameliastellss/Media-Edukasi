...
<section class="contact_section long_section">
    ...
    <h4>Tabel Unggah Rangkuman</h4> <p>&larr; <a href="tambah_rangkuman.php">Tabel Rangkuman</a>
    <hr>
    <form action="ScriptFileUpload_rangkuman.php" method="post" enctype="multipart/form-data">
        <b>Kode Rangkuman :</b>
