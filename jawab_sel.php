...
<br></br>     
<center><h5>HASIL LEMBAR SOAL BAB PEMBELAHAN SEL</h5></center>

<?php
  include "koneksi_job.php";
  ...
  if(isset($_POST['submit'])){
    ...
    for($i=0;$i<$jumlah;$i++){
      ...
      if(empty($pilihan[$nomor])){
        ...
        $sql = "SELECT * FROM soal_sel WHERE id_soal='$nomor' AND kunci='$jawaban'";
      ...
      */
      ...
      $sql = "SELECT * FROM soal_sel WHERE aktif='Y'";
      $query = mysqli_query($koneksi,$sql) or die (mysqli_error($koneksi));
  ...
  echo "Nilai: $hasil"."<br>";
?>
<p>&larr; <a href="bab_passive_voice.php">Back</a></p>
