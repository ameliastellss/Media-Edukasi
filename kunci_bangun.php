...
<br></br> 
<center><h5>HASIL LEMBAR SOAL BAB BANGUN RUANG</h5></center>


<?php
	include "koneksi_bangun.php";
	...
	if(isset($_POST['submit'])){
		...
		for($i=0;$i<$jumlah;$i++){
			...
			if(empty($pilihan[$nomor])){
				...
				$sql = "SELECT * FROM soal_bangun WHERE id_soal='$nomor' AND kunci='$jawaban'";
			...
			*/
			...
			$sql = "SELECT * FROM soal_bangun WHERE aktif='Y'";
			$query = mysqli_query($koneksi,$sql) or die (mysqli_error($koneksi));
...
<p>&larr; <a href="bab_bangun_ruang.php">Back</a></p>
