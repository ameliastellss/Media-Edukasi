...
<?php
  ...
  if(isset($_POST['submit'])){
    ...
    for($i=0;$i<$jumlah;$i++){
      ...
      if(empty($pilihan[$nomor])){
        ...
        $sql = "SELECT * FROM soal_complate WHERE id_soal='$nomor' AND kunci='$jawaban'";
      ...
      */
      ...
      $sql = "SELECT * FROM soal_complate WHERE aktif='Y'";
      $query = mysqli_query($koneksi,$sql) or die (mysqli_error($koneksi));
  ...
  echo "Nilai: $hasil"."<br>";
?>
<p>&larr; <a href="bab_complex-sentences.php">Back</a></p>
