...
<br></br>     
<center><h5>HASIL LEMBAR SOAL BAB LISTRIK STATIS</h5></center>

<?php
	include "koneksi_listrik.php";
	...
	if(isset($_POST['submit'])){
		...
		for($i=0;$i<$jumlah;$i++){
			...
			if(empty($pilihan[$nomor])){
				...
				$sql = "SELECT * FROM soal_listrik WHERE id_soal='$nomor' AND kunci='$jawaban'";
			...
			*/
			...
			$sql = "SELECT * FROM soal_listrik WHERE aktif='Y'";
			$query = mysqli_query($koneksi,$sql) or die (mysqli_error($koneksi));
