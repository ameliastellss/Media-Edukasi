...
<body>
 ...
 <br></br>   
<center><h5>HASIL LEMBAR SOAL BAB pencernaan LAMARAN</h5></center>
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		for($i=0;$i<$jumlah;$i++){
			...
			if(empty($pilihan[$nomor])){
				...
				$sql = "SELECT * FROM soal_pencernaan WHERE id_soal='$nomor' AND kunci='$jawaban'";
			...
			*/
			...
			$sql = "SELECT * FROM soal_pencernaan WHERE aktif='Y'";
			$query = mysqli_query($koneksi,$sql) or die (mysqli_error($koneksi));
  ...
  echo "Nilai: $hasil"."<br>";
?>
<p>&larr; <a href="bab_pencernaan.php">Back</a></p>
